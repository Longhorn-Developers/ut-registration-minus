const splashText: string[] = [
    ...
    'Is "bit" synonymous with "byte"? Really quick question before the test.',
    'Some bytes of crumbl cookies would hit rn...',
    'Ur not a big back if u take nibbles instead of bytes',
];
