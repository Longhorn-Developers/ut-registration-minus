const splashText: string[] = [
    ...
    'Planner is now acquired by Minus',
    ...
    'UT Registration Minus - The only thing that can make registration worse is not having it',
    'UT Registration Minus - We make registration slightly less painful. Slightly.',
    'UT Registration Minus - Do you really want to figure out which professors will ruin your GPA by yourself?',
    ...
    "Data Science > Comp Sci",
    "lol whats your registration time?",
    "stealth startup uh, what do you do?"
];
